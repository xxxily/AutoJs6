...
表格中 `活躍維護期` 列包含尖括號 (`<>`) 的資料, 其統計截止日期為 2026 年 6 月 7 日.
...
* `最佳化` 部分依賴或本地庫版本調整 _[`CHANGELOG.md`](http://project.autojs6.com/blob/master/app/src/main/assets-app/doc/CHANGELOG.md#v670)_
...
截至 2026 年 6 月 7 日, AutoJs6 可支援 JDK 最高版本為 `25`.
