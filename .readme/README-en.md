...
In the table, data in the `Active Maintenance` column that contains angle brackets (`<>`) is calculated up to Jun 7, 2026.
...
As of Jun 7, 2026, AutoJs6 supports up to version `25` of the JDK.
