...
In the table, data in the `Active Maintenance` column that contains angle brackets (`<>`) is calculated up to Jun 10, 2026.
...
* [Rhino](https://github.com/mozilla/rhino/) engine upgraded from [v1.7.7.2](https://github.com/mozilla/rhino/releases/tag/Rhino1_7_7_2_Release) to [v2.0.0-SNAPSHOT](http://rhino.autojs6.com/blob/master/gradle.properties#L3) (Updated on Dec 25, 2025)
...
> Note: The release date for the above version is Mar 3, 2026. To download other versions, or if the above link is invalid, you can visit the [Android Studio release archive](https://developer.android.com/studio/archive?hl=en) page.
...
As of Jun 10, 2026, AutoJs6 supports up to version `25` of the JDK.
