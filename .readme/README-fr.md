...
* Le moteur [Rhino](https://github.com/mozilla/rhino/) a été mis à niveau de [v1.7.7.2](https://github.com/mozilla/rhino/releases/tag/Rhino1_7_7_2_Release) à [v2.0.0-SNAPSHOT](http://rhino.autojs6.com/blob/master/gradle.properties#L3) (mis à jour le 25 December 2025)
...
Téléchargez la version `Android Studio Panda 2 | 2025.3.2` (choisissez-en une selon vos besoins):
...
> Note : La version mentionnée ci-dessus a été publiée le 3 March 2026. Pour télécharger d'autres versions ou si le lien ci-dessus n'est plus valide, visitez la page [archive des versions de Android Studio](https://developer.android.com/studio/archive?hl=en).
...
Données mises à jour le 4 March 2026.
